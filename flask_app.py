    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if reviews.count() > 0:  # if there is a collection with searched keyword and it has records in it
                ...
                flipkart_url = "https://www.flipkart.com/search?q=" + searchString  # preparing the URL to
                # search the product on flipkart
                ...
                commentboxes = prod_html.find_all('div', {'class': "_16PBlm"})  # finding the HTML section contaiing the customer comments
